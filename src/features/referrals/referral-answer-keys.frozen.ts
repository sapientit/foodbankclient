...
export const FROZEN_ANSWER_KEYS: readonly FrozenAnswerKey[] = [
  ...
  { key: 'Other', type: 'text' },
  // Version 4 — one composition table replaces the reverted separate age bands.
  { key: 'Household composition', type: 'householdComposition' },
  { key: 'Household Components', type: 'householdComposition' },
  { key: 'Collection method', type: 'choice' },
  { key: 'deliveryConfirm', type: 'choice' },
  // Version 4 — expanded questionnaire supplied from the reviewed Sheet.
  { key: 'gender', type: 'choice' },
  { key: 'ethnicity', type: 'choice' },
  { key: 'ethnicity other', type: 'text' },
  { key: 'languages', type: 'text' },
  { key: 'refereeEmail', type: 'text' },
  { key: 'source of income', type: 'choice' },
  { key: 'Allergies', type: 'text' },
  { key: 'Cooking Facility', type: 'choice' },
  { key: 'Tampons', type: 'choice' },
  { key: 'Sanitary Pads', type: 'choice' },
  { key: 'Cat food', type: 'choice' },
  { key: 'Dog food', type: 'choice' },
  { key: 'FuelPension', type: 'choice' },
  { key: 'Electricity crisis', type: 'text' },
  { key: 'Electricity Smart', type: 'choice' },
  { key: 'Gas crisis', type: 'text' },
  { key: 'Gas Smart', type: 'choice' },
  { key: 'Electricity debt', type: 'choice' },
  { key: 'Gas debt', type: 'choice' },
  { key: 'Permission', type: 'choice' },
  { key: 'reasonAdditional', type: 'text' },
];
