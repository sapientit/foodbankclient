...
describe('the weekly session list', () => {
  it('relies on the session tabs for navigation while offering the add-template action', async () => {
    ...
    expect(screen.queryByRole('link', { name: 'Back to sessions' })).toBeNull();
  });
