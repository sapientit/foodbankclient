 ...
 * `users-screen-forbidden.test.tsx`.
 *
 * A team lead has no Model parcels or Household grid link in their menu
 ...
 */
describe('a team lead typing a model-parcels URL', () => {
  it('lets a team lead reach the model parcels screen and shows the API’s refusal', async () => {
    const listed = vi.fn();
  ...
  it('offers a team lead neither a Model parcels nor a Household grid link', async () => {
    server.use(
      http.post('/api/v1/auth/refresh', () =>
        HttpResponse.json({
          accessToken: 'fresh-token',
