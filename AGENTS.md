...
- `../foodbankserver/AGENTS.md` — the domain model and the settled decisions behind it.
...
- **Use the server's domain words** — session, recurring session, referral, household, parcel, pick
  ...
  "order", "basket" and "template" all mean something else here. `../foodbankserver/AGENTS.md` has
  the definitions.
