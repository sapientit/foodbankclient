...
- **Generous `staleTime`, and never poll, except the SMS summary while its run-session screen is open and the administrator dashboard's SMS attention summary every five minutes in the foreground.** Session lists and stock levels do not change second to
